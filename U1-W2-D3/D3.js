...
{
  const allname = starWarsCharacters[i].name
 console.log(starWarsCharacters[i].name[allname])
...
switch (starWarsCharacters[i].eye_color){
  ...
  case "R5-D4":eyeColor[red]
  case "red":
  eyeColor.red.push(starWarsCharacters[i])
  break;

  case "Biggs Darklighter":eyeColor[brown]
  case "brown":
  eyeColor.brown.push(starWarsCharacters[i])
  break;
...
for (i=0; i<starWarsCharacters.length;i++)
  ...
  robot.push(starWarsCharacters[i])
